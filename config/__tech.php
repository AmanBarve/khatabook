...
$techConfig = require ('config/tech-config.php');
...
$techAppConfig = [
    ...
    'settings' => [
        ...
        'fields' => [
            ...
            'store_address'        => [
                ...
                'data_type'     => 1,    // string
                'default'       => '',
                'placeholder'   => 'add your Warehouse address'
            ],
            'store_country'        => [
                'key'           => 'store_country',
                'data_type'     => 1,    // string
                'default'       => 'add your country address'
            ],
            'store_state'        => [
                'key'           => 'store_state',
                'data_type'     => 1,    // string
                'default'       => '',
                'placeholder'   => 'add your state address'
            ],
            'store_city'        => [
                'key'           => 'store_city',
                'data_type'     => 1,    // string
                'default'       => 'add your city address'
            ],
            'store_pincode'        => [
                'key'           => 'store_pincode',
                'data_type'     => 1,    // integer
                'default'       => 'add your address pincode'
            ],
            'store_GSTIN'        => [
                'key'           => 'store_GSTIN',
                'data_type'     => 1,    // integer
                'default'       => 'add your address GSTIN'
            ],
            'store_Rules'        => [
                'key'           => 'store_Rules',
                'data_type'     => 1,    // integer
                'default'       => 'add your address Rules'
            ],
    ...
    'landing_page_content' => [
        ...
        8 => [
            'title'    => '3Boxheader',
            'banner_3_section_1_image_thumb' => '',
            'banner_3_section_1_image' => '',
            'banner_3_section_1_heading_1' => '',
            'banner_3_section_1_description' => '',
            
            'banner_3_section_2_image_thumb' => '',
            'banner_3_section_2_image' => '',
            'baner_3_section_2_heading_1' => '',
            'baner_3_section_2_description' => '',

            'banner_3_section_3_image_thumb' => '',
            'banner_3_section_3_image' => '',
            'baner_3_section_3_heading_1' => '',
            'baner_3_section_3_description' => '',

            'orderIndex'  => 8,
            'identity'  => 'bannerContent3',
            'isEnable'  =>  false
        ],
        9 => [
            'Deal_of_the_day_ProductCount'    => 10,
            'orderIndex'  => 9,
            'identity'  => 'Deal_of_the_day_Product',
            'isEnable' => true
        ],
    ],
...
$appTechConfig = require ('user-tech-config.php');
